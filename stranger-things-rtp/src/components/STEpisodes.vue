<template>
  <div id="episodes-div" class="episodes">
    ...
    <section class="season1-list">
      ...
      <ul>
        <li class="season1-episodes" v-for="episode in season1Episodes">  {{episode.name}}
    ...
    <section class="season2-list">
      ...
      <ul>
        <li class="season1-episodes" v-for="episode in season2Episodes">  {{episode.name}}
          <div class="rating">Rating: {{episode.rating}}</div>
        </li>
      </ul>
    </section>
...
<style>
  ...
  .season1-list ul, .season2-list ul {
  ...
  .season1-list li, .season2-list li {
    margin: 10px 0px;
    color: red;
  }
